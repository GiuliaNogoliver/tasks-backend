pipeline {
    ...
    post {
        always {
            ...
            // archiveArtifacts artifacts: 'target/tasks-backend.war, fronted/target/tasks.war', followSymlinks: false, onlyIfSuccessful: true
        }
        unsuccessful {
        ...
        fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build is fine!', to: 'developer.giulia@gmail.com'
        }
    }
}